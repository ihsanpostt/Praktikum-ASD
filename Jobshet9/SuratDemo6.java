...
public class SuratDemo6 {
    public static void main(String[] args) {
        StackSurat6 stack = new StackSurat6(5);
...
do {
    ...
    switch (pilih) {
        case 1:
            ...
            Surat6 surat = new Surat6(idSurat, nama, kelas, jenisIzin, durasi);
            stack.push(surat);
            System.out.printf("Surat %s berhasil dikumpulkan\n", surat.namaMhs);
            break;
        case 2:
        Surat6 suratVerif = stack.pop();
        if (suratVerif != null) {
        ...
        break;
        case 3:
        Surat6 suratTeratas = stack.peek();
